package com.example.mymiso.adapter
...
import com.example.mymiso.model.User
...
class UserRecyclerViewAdapter : RecyclerView.Adapter<UserRecyclerViewAdapter.UserViewHolder>() {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): UserRecyclerViewAdapter.UserViewHolder {
    ...
    override fun onBindViewHolder(holder: UserRecyclerViewAdapter.UserViewHolder, position: Int) {
